...
public class PrezSocialATDP
{
    public static void main(String[] args)
    {
        ...
        PrezATDP prezA2 = new PrezATDP("Jefferson", 44);  prezW.addFriend(prezA2);
        PrezATDP prezA3 = new PrezATDP("Madison", 44);   prezW.addFriend(prezA3);
        PrezATDP prezA4 = new PrezATDP("Monroe", 44); prezW.addFriend(prezA4);
      ...
      // UNFRIEND
        prezW.unfriend(prezA2);
      
       // SHOW RESULTS: AFTER UNFRIENDING
        System.out.print("\nRESULT after trying to unFriend (" + prezW.getOwnName() + "): ");
        System.out.println(prezW.getOwnName() + " has " + prezW.getFriendCount() + " friends: "
                   + prezW.getAllFriendsNames());
